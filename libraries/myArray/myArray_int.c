...
#define array_scan array_scan_int
#define array_scan_file array_scan_file_int
#define array_print array_print_int
#define array_print_file array_print_file_int
#define array_swap array_swap_int
#define array_partition array_partition_int
#define array_heapify array_heapify_int
#define array_merge array_merge_int
#define array_insertion_sort array_insertion_sort_int
#define array_selection_sort array_selection_sort_int
#define array_bubble_sort array_bubble_sort_int
#define array_quick_sort array_quick_sort_int
